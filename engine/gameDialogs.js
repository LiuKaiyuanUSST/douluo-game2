...
export function showMhjNewPartnerChoice() {
    ...
    const container = document.createElement('div');
    container.id = 'mhj-partner-container';
    container.style.cssText = `
        position: fixed;
        top: 50%;
        left: 50%;
    ...
    function showPartnerSelection() {
        container.innerHTML = `
            ...
            <div style="font-size:16px; line-height:1.7; margin-bottom:16px; padding:14px; background:#1a2a1a; border-radius:8px; border:1px solid #4a6a4a;">
            ...
            ${availablePartners.map((p, idx) => `
                <button class="mhj-partner-choice-btn" data-index="${idx}" style="
                    display:block; margin:8px 0; padding:12px 15px; width:100%;
                    background:#2a3a4a; color:white; border:2px solid ${p.color}; border-radius:8px;
                    cursor:pointer; font-size:16px; text-align:left;
                    transition: background 0.2s;
    ...
    function showPartnerWuhunChoice(chosen) {
        ...
        allOptions.forEach((opt, index) => {
            const recText = opt.isRecommended ? ' <span style="color:#ff6b6b; font-size:14px;">（推荐）</span>' : '';
            optionsHtml += `
                <button class="mhj-partner-wuhun-btn" data-index="${index}" style="
                    display:block; margin:8px 0; padding:12px 15px; width:100%;
                    background:#2a3a4a; color:white; border:2px solid #4a6a7f; border-radius:8px;
                    cursor:pointer; font-size:16px; text-align:left;
                    transition: background 0.2s;
    ...
    function applyPartnerWuhun(chosen, wuhunName) {
        ...
        container.innerHTML = `
            ...
            <button id="mhj-partner-finish-btn" style="
                display:block; margin:15px auto; padding:12px 40px;
                background:#2ecc71; color:white; border:none; border-radius:8px;
                cursor:pointer; font-size:20px; font-weight:bold;
            ">继续冒险</button>
...
export function showQiGuaiPartnerChoice() {
    ...
    const container = document.createElement('div');
    container.id = 'qigui-partner-container';
    container.style.cssText = `
        position: fixed;
        top: 50%;
        left: 50%;
    ...
    function showPartnerSelection() {
        container.innerHTML = `
            ...
            ${availablePartners.map((p, idx) => `
                <button class="qigui-partner-choice-btn" data-index="${idx}" style="
                    display:block; margin:8px 0; padding:12px 15px; width:100%;
                    background:#2a3a4a; color:white; border:2px solid ${p.color}; border-radius:8px;
                    cursor:pointer; font-size:16px; text-align:left;
                    transition: background 0.2s;
    ...
    function showPartnerWuhunChoice(chosen) {
        ...
        allOptions.forEach((opt, index) => {
            const recText = opt.isRecommended ? ' <span style="color:#ff6b6b; font-size:14px;">（推荐）</span>' : '';
            optionsHtml += `
                <button class="qigui-partner-wuhun-btn" data-index="${index}" style="
                    display:block; margin:8px 0; padding:12px 15px; width:100%;
                    background:#2a3a4a; color:white; border:2px solid #4a6a7f; border-radius:8px;
                    cursor:pointer; font-size:16px; text-align:left;
                    transition: background 0.2s;
    ...
    function applyPartnerWuhun(chosen, wuhunName) {
        ...
        container.innerHTML = `
            ...
            <button id="qigui-partner-finish-btn" style="
                display:block; margin:15px auto; padding:12px 40px;
                background:#2ecc71; color:white; border:none; border-radius:8px;
                cursor:pointer; font-size:20px; font-weight:bold;
            ">进入迷宫</button>
...
export function showQiGuaiFirstReturnHint() {
    ...
    const container = document.createElement('div');
    container.id = 'qigui-return-hint-container';
    container.style.cssText = `
        position: fixed;
        top: 50%;
        left: 50%;
    ...
    container.innerHTML = `
        ...
        <button id="qigui-return-hint-ok-btn" style="
            display:block; margin:0 auto; padding:12px 40px;
            background:#2ecc71; color:white; border:none; border-radius:8px;
            cursor:pointer; font-size:18px; font-weight:bold;
        ">知道了</button>
